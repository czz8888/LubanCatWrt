...
#ifdef CONFIG_SUNXI_DTB_OFFSET
	/*
	* If uboot and uboot-dtb images are separated, the address of ubootdtb needs to be relocated.
	* uboot_dtb_base = uboot base + 2M offset.
	*/
	fdt_blob = (ulong*)(CONFIG_TEXT_BASE + 2 * 1024 * 1024);
#endif
