...
extern int ubi_nand_download_private_ubidev(unsigned int len, void *buf);
extern int ubi_nand_download_boot0(unsigned int len, void *buf);
extern int ubi_nand_download_boot_param(void);
...
extern int sunxi_flash_nand_download_boot_param(void);
