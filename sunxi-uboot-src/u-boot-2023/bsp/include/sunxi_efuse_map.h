...
#define EFUSE_CUSTOMER_RESERVED_NAME "customer_reserved"
...
#define EFUSE_SCK0_BURN_BYTE         ((256+256)>>3)
#define EFUSE_SCK1_BURN_BYTE         ((256+256)>>3)
...
enum sunxi_efuse_req_ioctl {
	SUNXI_EFUSE_IOCTL_SET_VOL,
	SUNXI_EFUSE_IOCTL_READ_KEY,
	SUNXI_EFUSE_IOCTL_SET_SMODE,
	SUNXI_EFUSE_IOCTL_PROBE_SMODE,
	SUNXI_EFUSE_IOCTL_GET_SSTATUS,
	SUNXI_EFUSE_IOCTL_READ,
	SUNXI_EFUSE_IOCTL_WRITE,
	SUNXI_EFUSE_IOCTL_GET_ROTPK_STATUS,
	SUNXI_EFUSE_IOCTL_VERIFY_ROTPK,
	SUNXI_EFUSE_IOCTL_GET_SOC_VER,
	SUNXI_EFUSE_IOCTL_MAX = 0xFF,
};
