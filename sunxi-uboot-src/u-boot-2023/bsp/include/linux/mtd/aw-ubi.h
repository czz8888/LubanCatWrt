...
struct ubi_mtd_part {
	...
	/*skip bad block sects*/
	unsigned int skip_sects;
	int last_skip_block;
};
...
extern struct udevice *rawnand_dev;
#endif

#ifdef CONFIG_AW_MTD_SPINAND
extern struct udevice *spinand_dev;
#endif

extern struct udevice *cur_sunxi_flash;
extern struct udevice *spr_sunxi_flash;
