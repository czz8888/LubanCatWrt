...
#define CONFIG_SPINAND_DEFAULT_SPEED	(30000000)
#define CONFIG_SPINAND_LOW_SPEED	(20000000)
...
#define SPINAND_CONTINUOUS_READ			BIT(9)
	int OperationOpt;
	int MaxEraseTimes;
...
extern int spinand_mtd_init(unsigned int busnum, unsigned int cs,
		struct udevice **devp);
extern int spinand_ubi_attach_mtd(void);
...
extern void spinand_download_boot_param(void);
