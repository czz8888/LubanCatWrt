...
#define NDFC_DESC_ALIGNMENT	2
#else
#define NDFC_DESC_ALIGNMENT	0
#endif
...
extern void rawnand_download_boot_param(void);
...
extern int rawnand_mtd_init(struct udevice **devp);
...
extern int rawnand_ubi_attach_mtd(void);
...
extern uint64_t rawnand_sys_part_offset(void);
