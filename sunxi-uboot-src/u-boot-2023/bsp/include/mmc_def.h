...
#define DRIVER_VER  "uboot2023:2025-04-02 14:45:00"
...
#define TUNING_ADD		(CONFIG_SUNXI_SDMMC_UBOOT_BACKUP_START_ADDR-4-TUNING_LEN)//The address which store the tuninng pattern
