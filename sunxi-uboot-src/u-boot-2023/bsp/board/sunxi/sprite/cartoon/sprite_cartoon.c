...
int do_sunxi_screen_char(struct cmd_tbl *cmdtp, int flag, int argc,
			 char *const argv[])
{
...
int suxi_clear_screen(struct cmd_tbl *cmdtp, int flag, int argc,
			 char *const argv[])
{
	return clear_screen();
}
int sunxi_screen_char(struct cmd_tbl *cmdtp, int flag, int argc,
			 char *const argv[])
{
	int x = 0, y = 0;
	if (argc == 4) {
