...
#include <asm/arch/plat-sun252iw1p1/clock_autogen.h>
...
#define  ve_clk_cfg              pll_ve_ctrl_reg
...
#define CE_MBUS_GATING_BIT                (MBUS_MAT_CLK_GATING_REG_CE_MBUS_GATE_SW_CFG_OFFSET)
//@TODO
#define CE_MBUS_GATING                    (MBUS_MAT_CLK_GATING_REG_CE_MBUS_GATE_SW_CFG_ENABLE)
...
#define CCMU_PLL_CPU0_CTRL_REG (SUNXI_CPU_SUBSYS_CTRL_BASE + 0x20)
#define CCMU_PLL_CPU1_CTRL_REG (SUNXI_CPU_SUBSYS_CTRL_BASE + 0x24)
#define CCMU_PLL_CPU2_CTRL_REG (SUNXI_CPU_SUBSYS_CTRL_BASE + 0x28)
#define CCMU_PLL_CPU3_CTRL_REG (SUNXI_CPU_SUBSYS_CTRL_BASE + 0x2c)

#define CCMU_PLL_CPU_CFG_REG (SUNXI_CPU_SUBSYS_CTRL_BASE + 0x870000)

struct sunxi_cpu_pll_reg{
	uint32_t pad_until_0x04[1]; /*0x00*/
	uint32_t cpu_l0_pll_ctrl_reg;
	uint32_t cpu_dsu_pll_ctrl_reg;
	uint32_t cpu_l0_pll_part0_ctrl_reg;
	uint32_t cpu_l0_pll_part1_ctrl_reg; /*0x10*/
	uint32_t cpu_dsu_pll_patt0_ctrl_reg;
	uint32_t cpu_dsu_pll_patt1_ctrl_reg;
	uint32_t pad_until_0x20[1];
	uint32_t cpu_l0_pll_bias_reg; /*0x20*/
	uint32_t cpu_dsu_pll_bias_reg;
	uint32_t pad_until_0x30[2];
	uint32_t cpu_l0_pll_tun1_reg; /*0x30*/
	uint32_t pad_until_0x38[1];
	uint32_t cpu_dsu_pll_tun1_reg;
	uint32_t cpu_l0_pll_ssc_reg;
	uint32_t cpu_dsu_pll_ssc_reg; /*0x40*/
	uint32_t cpu_clk_reg;
	uint32_t cpu_gating_reg;
	uint32_t dsu_clk_reg;
	uint32_t pll_test_clk_sel; /*0x50*/
	uint32_t pad_until_0x74[8];
	uint32_t cpu_l0_pll_echo_reg;
	uint32_t cpu_dsu_pll_echo_reg;
};

struct sunxi_cpu_wdt_reg{
	uint32_t wd_irq_en; /*0x0*/
	uint32_t wd_irq_sta; /*0x4*/
	uint32_t wd_soft_reset; /*0x8*/
	uint32_t wd_ctrl; /*0xc*/
	uint32_t wd_cfg; /*0x10*/
	uint32_t wd_mode; /*0x14*/
	uint32_t wd_ocfg; /*0x18*/
};
