...
#ifdef CONFIG_MACH_SUN252IW1
#define AW_IRQ_USB_OTG                 (29)
#define AW_IRQ_USB_EHCI0               (30)
#define AW_IRQ_USB_OHCI0               (31)
#define AW_IRQ_DMA                     (37)
#define AW_IRQ_TIMER0                  (55)
#define AW_IRQ_TIMER1                  (56)
#define AW_IRQ_NMI                     (136)
#define PLIC_IRQ_NUM                   (143)
...
/* PLIC registers */
#define PLIC_PRIO_REG(_n)		(IOMEM_ADDR(SUNXI_PLIC_BASE) + 0x0004 + (_n - 1) * 4)
...
#define PLIC_M_S_TH_REG			(get_cur_riscv_mode() == PRV_M ? PLIC_MTH_REG : PLIC_STH_REG)
