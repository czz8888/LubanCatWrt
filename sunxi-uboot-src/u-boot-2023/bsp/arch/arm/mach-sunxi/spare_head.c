...
/* jump_instruction */
#ifdef CONFIG_ARM64
		(0x14000000 | (sizeof(struct spare_boot_head_t) / 4)),
#else
		(0xEA000000 |
		 (((sizeof(struct spare_boot_head_t) + sizeof(int) - 1) /
			   sizeof(int) -
		   2) &
		  0x00FFFFFF)),
#endif
	...
	{ { 0 }, //dram para
	  ...
	  { 0 }, //reserved data
#ifdef CONFIG_SUNXI_SDMMC_UBOOT_START_ADDR
	  CONFIG_SUNXI_SDMMC_UBOOT_START_ADDR, //OTA flag
#else
	  32800,
#endif
	  0, //dtb offset
