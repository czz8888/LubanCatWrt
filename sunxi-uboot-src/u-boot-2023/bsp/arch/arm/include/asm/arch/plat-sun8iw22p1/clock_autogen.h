...
#ifndef __CLK_AUTOGEN_H
#define __CLK_AUTOGEN_H
...
struct CCU_st {
	...
	uint32_t pll_cpu_tun1_reg;//pll_cpu tuning1 control register
	uint32_t pll_cpu_ssc_reg;//pll_cpu ssc register
	uint32_t pll_cpu_echo_reg;//pll_cpu echo register
	uint32_t pad_until_0x0500[105];
	...
	uint32_t pad_until_0x0588[19];
	uint32_t mbus_clk_reg;//mbus clock register
	uint32_t pad_until_0x05c0[13];
	uint32_t ahb_mat_clk_gate_en_reg;//ahb master clock gate enable register
	uint32_t pad_until_0x05d0[3];
	uint32_t peri_mat_clk_gate_en_reg;//peri master clock gate enable register
	uint32_t pad_until_0x05e0[3];
	...
	uint32_t pad_until_0x05f0[2];
	uint32_t ahb_mat_clk_auto_gate_en_reg;//ahb master clock auto gate enable register
	uint32_t mbus_mat_clk_auto_gate_en_reg;//mbus master clock auto gate enable register
	uint32_t ahb_mat_clk_gate_stat_reg;//ahb master clock gate status register
	uint32_t mbus_mat_clk_gate_stat_reg;//mbus master clock gate status register
	uint32_t pad_until_0x0704[65];
	uint32_t dma_gate_reset;//dma0 gating and reset register
	uint32_t pad_until_0x070c[1];
	uint32_t dma1_gar_reg;//dma1 gating and reset register
	...
	uint32_t msgbox_core0_gar_reg;//msgbox_core0 gating and reset register
	uint32_t pad_until_0x0754[1];
	uint32_t msgbox_core1_gar_reg;//msgbox_core1 gating and reset register
	uint32_t pad_until_0x075c[1];
	uint32_t msgbox_core2_gar_reg;//msgbox_core2 gating and reset register
	uint32_t pad_until_0x0764[1];
	uint32_t msgbox_core3_gar_reg;//msgbox_core3 gating and reset register
	uint32_t pad_until_0x076c[1];
	uint32_t msgbox_rv_gar_reg;//msgbox_riscv gating and reset register
	uint32_t pad_until_0x0784[5];
	uint32_t pwm0_gar_reg;//pwm0 gating and reset register
	uint32_t pad_until_0x078c[1];
	uint32_t pwm1_gar_reg;//pwm1 gating and reset register
	uint32_t pad_until_0x0794[1];
	uint32_t pwm2_gar_reg;//pwm2 gating and reset register
	...
	uint32_t pad_until_0x07c0[4];
	uint32_t pwmcs0_clk_reg;//pwmcs0 clock register
	uint32_t pwmcs0_gar_reg;//pwmcs0 gating and reset register
	uint32_t pwmcs1_clk_reg;//pwmcs1 clock register
	uint32_t pwmcs1_gar_reg;//pwmcs1 gating and reset register
	uint32_t pad_until_0x0800[12];
	uint32_t timer0_0_clk_reg;//timer0_0 clock register
	uint32_t timer0_1_clk_reg;//timer0_1 clock register
	uint32_t timer0_2_clk_reg;//timer0_2 clock register
	uint32_t timer0_3_clk_reg;//timer0_3 clock register
	uint32_t timer0_4_clk_reg;//timer0_4 clock register
	uint32_t timer0_5_clk_reg;//timer0_5 clock register
	uint32_t timer0_6_clk_reg;//timer0_6 clock register
	uint32_t timer0_7_clk_reg;//timer0_7 clock register
	uint32_t pad_until_0x0850[12];
	uint32_t timer0_gar_reg;//timer0 gating and reset register
	uint32_t pad_until_0x0860[3];
	uint32_t timer0_0_rv_clk_reg;//timer0_0_riscv clock register
	uint32_t timer0_1_rv_clk_reg;//timer0_1_riscv clock register
	uint32_t timer0_2_rv_clk_reg;//timer0_2_riscv clock register
	uint32_t timer0_3_rv_clk_reg;//timer0_3_riscv clock register
	uint32_t timer0_rv_gar_reg;//timer0_riscv gating and reset register
	...
	uint32_t rv_sys_gar_reg;//riscv_sys gating and reset register
	uint32_t pad_until_0x0b9c[1];
	uint32_t rv_cfg_gar_reg;//riscv_cfg gating and reset register
	uint32_t pad_until_0x0c0c[27];
	uint32_t dramc_gar_reg;//dramc gating and reset register
	...
	uint32_t uart8_gar_reg;//uart8 gating and reset register
	uint32_t uart9_gar_reg;//uart9 gating and reset register
	uint32_t pad_until_0x0e80[21];
	...
	uint32_t spif_gar_reg;//spif gating and reset register
	uint32_t spi3_clk_reg;//spi3 clock register
	uint32_t spi3_gar_reg;//spi3 gating and reset register
	uint32_t pad_until_0x0fbc[38];
	...
	uint32_t gpadc1_gar_reg;//gpadc1 gating and reset register
	uint32_t gpadc2_clk_reg;//gpadc2 clock register
	uint32_t gpadc2_gar_reg;//gpadc2 gating and reset register
	uint32_t pad_until_0x0fe4[3];
	uint32_t tsensor_gar_reg;//tsensor gating and reset register
	uint32_t pad_until_0x1000[6];
	uint32_t ir_rx0_clk_reg;//ir_rx0 clock register
	uint32_t ir_rx0_gar_reg;//ir_rx0 gating and reset register
	uint32_t ir_tx_clk_reg;//ir_tx clock register
	uint32_t ir_tx_gar_reg;//ir_tx gating and reset register
	uint32_t pad_until_0x1030[8];
	uint32_t tpadc_clk_reg;//tpadc clock register
	uint32_t tpadc_gar_reg;//tpadc gating and reset register
	uint32_t pad_until_0x1040[2];
	uint32_t lbc_clk_reg;//lbc clock register
	uint32_t pad_until_0x104c[2];
	uint32_t lbc_gar_reg;//lbc gating and reset register
	uint32_t pad_until_0x1100[44];
	uint32_t ir_rx1_clk_reg;//ir_rx1 clock register
	uint32_t ir_rx1_gar_reg;//ir_rx1 gating and reset register
	uint32_t ir_rx2_clk_reg;//ir_rx2 clock register
	uint32_t ir_rx2_gar_reg;//ir_rx2 gating and reset register
	uint32_t ir_rx3_clk_reg;//ir_rx3 clock register
	uint32_t ir_rx3_gar_reg;//ir_rx3 gating and reset register
	...
	uint32_t audiocodec0_dac_clk_reg;//audiocodec0 dac clock register
	uint32_t pad_until_0x12ec[2];
	uint32_t audiocodec0_gar_reg;//audiocodec0 gating and reset register
	...
	uint32_t usb2p0_sys_phy_ref_clk_reg;//usb2p0_sys phy reference clock register
	uint32_t usb2p0_sys_gar_reg;//usb2p0_sys gating and reset register
	uint32_t pad_until_0x1400[46];
	uint32_t gmac0_phy_clk_reg;//gmac0 phy clock register
	uint32_t gmac0_ptp_ref_clk_reg;//gmac0 ptp reference clock register
	uint32_t pad_until_0x140c[1];
	uint32_t gmac0_gar_reg;//gmac0 gating and reset register
	uint32_t gmac1_phy_clk_reg;//gmac1 phy clock register
	uint32_t gmac1_ptp_ref_clk_reg;//gmac1 ptp reference clock register
	uint32_t pad_until_0x141c[1];
	uint32_t gmac1_gar_reg;//gmac1 gating and reset register
	uint32_t gmac2_phy_clk_reg;//gmac2 phy clock register
	uint32_t gmac2_ptp_ref_clk_reg;//gmac2 ptp reference clock register
	uint32_t pad_until_0x142c[1];
	uint32_t gmac2_gar_reg;//gmac2 gating and reset register
	uint32_t pad_until_0x1500[52];
	uint32_t tcon_lcd0_clk_reg;//tcon_lcd0 clock register
	...
	uint32_t mipi_dsi0_clk_reg;//mipi_dsi0 clock register
	uint32_t mipi_dsi0_gar_reg;//mipi_dsi0 gating and reset register
	uint32_t pad_until_0x15c0[14];
	uint32_t combophy0_clk_reg;//combophy0 clock register
	...
	uint32_t pad_until_0x199c[2];
	uint32_t audiopll_gate_stat_reg;//audiopll gate status register
	uint32_t pad_until_0x1a20[32];
	uint32_t pll_opg_bypass_reg;//pll output gate bypass register
	uint32_t pad_until_0x1c00[119];
	uint32_t axi_mon_gar_reg;//axi mon gating and reset register
	uint32_t ahb_mon_gar_reg;//ahb mon gating and reset register
	uint32_t pad_until_0x1f00[190];
	...
	uint32_t pad_until_0x1f60[3];
	uint32_t fre_det_ctrl_reg;//frequence detect control register
	uint32_t fre_up_lim_reg;//frequence up limit register
	uint32_t fre_down_lim_reg;//frequence down limit register
	uint32_t pad_until_0x1ff0[33];
	uint32_t ccu_version_reg;//ccu version register
};

#endif /* __CLK_AUTOGEN_H */
