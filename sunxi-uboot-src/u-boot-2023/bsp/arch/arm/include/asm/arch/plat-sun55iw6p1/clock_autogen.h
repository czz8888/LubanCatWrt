...
struct CCMU_st {
	...
	uint32_t nand0_bgr_reg; //nand0 bus gating reset register
	...
	uint32_t pad_until_0x0f80[20];
	uint32_t pad_until_0x0fc0[16];
	...
	uint32_t pad_until_0x1048[1];
	uint32_t lbc_nsi_ahb_clk_reg; //lbc nsi ahb clock register
	...
	uint32_t serdes_axi_clk_reg; //serdes axi clock register
	...
	uint32_t vo0_combphy0_clk_reg; //vo0_combphy0 clock register
