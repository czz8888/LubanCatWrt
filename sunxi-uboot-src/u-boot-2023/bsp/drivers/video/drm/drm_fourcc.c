...
const struct drm_format_info *__drm_format_info(u32 format)
{
	static const struct drm_format_info formats[] = {
		...
		{ .format = DRM_FORMAT_P030,            .depth = 0,  .num_planes = 2,
		  ...
		  .hsub = 2, .vsub = 2, .is_yuv = true},
		{ .format = DRM_FORMAT_ARGB8565, .depth = 24, .num_planes = 1, .cpp = { 3, 0, 0 }, .hsub = 1, .vsub = 1, .has_alpha = true},
		{ .format = DRM_FORMAT_ABGR8565, .depth = 24, .num_planes = 1, .cpp = { 3, 0, 0 }, .hsub = 1, .vsub = 1, .has_alpha = true},
		{ .format = DRM_FORMAT_RGBA5658, .depth = 24, .num_planes = 1, .cpp = { 3, 0, 0 }, .hsub = 1, .vsub = 1, .has_alpha = true},
		{ .format = DRM_FORMAT_BGRA5658, .depth = 24, .num_planes = 1, .cpp = { 3, 0, 0 }, .hsub = 1, .vsub = 1, .has_alpha = true},
	};
