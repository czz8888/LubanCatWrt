...
#define DT_RANGE_TYPE_CFG                0x0
#define DT_RANGE_TYPE_IO                 0x1
#define DT_RANGE_TYPE_MEM32              0x2
#define DT_RANGE_TYPE_MEM64              0x3
...
struct sunxi_pcie_port {
	...
	phys_addr_t			cpu_cfg0_base;
	phys_addr_t			pcie_cfg0_base;
	phys_addr_t			cfg0_size;

	phys_addr_t			cpu_io_base;
	phys_addr_t			pcie_io_base;
	phys_addr_t			io_size;

	phys_addr_t			cpu_mem_base;
	phys_addr_t			pcie_mem_base;
...
#if IS_ENABLED(CONFIG_PCIE_ALLWINNER_EP)
