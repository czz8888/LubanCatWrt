				    ...
				    uint func_selector)
{
	...
	sunxi_debug(dev, "set mux: %-4s => %s (%d)\n",
...
static const struct sunxi_pinctrl_function sun8iw21_pinctrl_plat_functions[] = {
	{ "gpio_in",	0 },
	{ "gpio_out",	1 },
	{ "mmc0",	2 },	/* PF0-PF5 */
	{ "mmc1",	2 },	/* PG0-PG5 */
...
static const struct sunxi_pinctrl_desc __maybe_unused sun8iw21_pinctrl_plat_desc = {
	.functions	= sun8iw21_pinctrl_plat_functions,
	.num_functions	= ARRAY_SIZE(sun8iw21_pinctrl_plat_functions),
	.first_bank	= SUNXI_GPIO_A,
	.num_banks	= 9,
};
...
static const struct sunxi_pinctrl_desc __maybe_unused sun55iw6_pinctrl_plat_desc = {
...
static const struct sunxi_pinctrl_desc __maybe_unused sun55iw6_r_pinctrl_plat_desc = {
	.functions	= sun55iw6_r_pinctrl_plat_functions,
	.num_functions	= ARRAY_SIZE(sun55iw6_r_pinctrl_plat_functions),
	.first_bank	= SUNXI_GPIO_L,
	.num_banks	= 2,
};
static const struct sunxi_pinctrl_function sun65iw1_pinctrl_plat_functions[] = {
	{ "gpio_in",	0 },
	{ "gpio_out",	1 },
	{ "mmc0",	2 },	/* PF0-PF5 */
	{ "mmc1",	2 },	/* PG0-PG5 */
...
static const struct sunxi_pinctrl_desc __maybe_unused sun65iw1_pinctrl_plat_desc = {
	.functions	= sun65iw1_pinctrl_plat_functions,
	.num_functions	= ARRAY_SIZE(sun65iw1_pinctrl_plat_functions),
	.first_bank	= SUNXI_GPIO_A,
	.num_banks	= 9,
};
...
#endif
	{
		.compatible = "allwinner,sun8iw21-pinctrl",
		.data = (ulong)&sun8iw21_pinctrl_plat_desc,
	},
	{
		.compatible = "allwinner,sun65iw1-pinctrl",
		.data = (ulong)&sun65iw1_pinctrl_plat_desc,
	},
	{}
};
