...
#define   AXP517_IRQ1_STATUS			(0x49)

#define   AXP517_VBUS_POWER_ON			(BIT(7) | BIT(6))
#define   AXP517_BUTTON_POWER_ON		(BIT(3) | BIT(2))
#define   AXP517_BATTERY_POWER_ON		(BIT(5))
...
#define AXP517_EXT_PARA0           (0xF0)
#define AXP517_EXT_PARA1           (0xF1)
