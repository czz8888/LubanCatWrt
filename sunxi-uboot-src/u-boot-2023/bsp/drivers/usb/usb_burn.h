...
unsigned char sunxi_usb_pbur_normal_LangID[8] = { 0x04, 0x03, 0x09, 0x04,
						  '\0' };
...
unsigned char *sunxi_usb_pburn_dev[SUNXI_USB_PBURN_DEV_MAX] = {
	sunxi_usb_pbur_normal_LangID, sunxi_usb_pburn_iSerialNum0,
	sunxi_usb_pburn_iManufacturer, sunxi_usb_pburn_iProduct
};

const unsigned char pburn_InquiryData[40] = {
	0x00, 0x80, 0x02, 0x02, 0x1f, 0x00, 0x00, 0x00, 'U', 'S', 'B', '2', '.',
	'0',  0x00, 0x00, 'U',	'S',  'B',  ' ',  'S',	't', 'o', 'r', 'a', 'g',
	'e',  0x00, 0x00, 0x00, 0x00, 0x00, '0',  '1',	'0', '0', '\0'
};

const unsigned char pburn_RequestSense[20] = { 0x07, 0x00, 0x02, 0x00, 0x00,
