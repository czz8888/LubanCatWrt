...
#define AW_SPINAND_PHY_VER_SUB		0x19
#define AW_SPINAND_PHY_VER_DATE		0x20250528
...
#define SPI_NAND_EN_POWRT_RESET	0x66
#define SPI_NAND_POWRT_RESET	0x99
...
#define VALID_CACHE_DATA	BIT(2)
	unsigned int area_data;
	unsigned int area_oob;
