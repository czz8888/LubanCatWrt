...
*
*@sunxi_certif Stores intermediate variables required during certificate verification.
*@buf Certificate starting address.
*@len data len.
*
*@return If the verification is successful, return 0; otherwise return -1.
*
*/
